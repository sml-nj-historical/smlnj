...
type cfun_ML_polldesc_list_t = (word * word) list
type ML_pollinfo_list_t = (word * word) list
type cfun_ML_pollinfo_list_t = (word * word) list
...
type cfun_Date_t = (Int.int * Int.int * Int.int * Int.int * Int.int * Int.int * Int.int * Int.int * Int.int)
...
val cfun_readTextVec : (cfun_ML_bool_t * cfun_ML_iodesc_t * Int.int) -> cfun_ML_charvec_opt_t = C.c_function "SMLBasis" "readTextVec"
...
val cfun_readTextArr : (cfun_ML_bool_t * cfun_ML_iodesc_t * cfun_ML_chararr_t * Int.int * Int.int) -> cfun_ML_int_t = C.c_function "SMLBasis" "readTextArr"
...
val cfun_writeTextVec : (cfun_ML_bool_t * cfun_ML_iodesc_t * cfun_ML_charvec_t * Int.int * Int.int) -> cfun_ML_int_t = C.c_function "SMLBasis" "writeTextVec"
...
val cfun_writeTextArr : (cfun_ML_bool_t * cfun_ML_iodesc_t * cfun_ML_chararr_t * Int.int * Int.int) -> cfun_ML_int_t = C.c_function "SMLBasis" "writeTextArr"
...
val cfun_readBinVec : (cfun_ML_bool_t * cfun_ML_iodesc_t * Int.int) -> cfun_ML_word8vec_opt_t = C.c_function "SMLBasis" "readBinVec"
...
val cfun_readBinArr : (cfun_ML_bool_t * cfun_ML_iodesc_t * cfun_ML_word8arr_t * Int.int * Int.int) -> cfun_ML_int_t = C.c_function "SMLBasis" "readBinArr"
...
val cfun_writeBinVec : (cfun_ML_bool_t * cfun_ML_iodesc_t * cfun_ML_word8vec_t * Int.int * Int.int) -> cfun_ML_int_t = C.c_function "SMLBasis" "writeBinVec"
...
val cfun_writeBinArr : (cfun_ML_bool_t * cfun_ML_iodesc_t * cfun_ML_word8arr_t * Int.int * Int.int) -> cfun_ML_int_t = C.c_function "SMLBasis" "writeBinArr"
...
val cfun_syserror : String.string -> cfun_ML_int_opt_t = C.c_function "SMLBasis" "syserror"
...
val cfun_osSystem : String.string -> cfun_ML_int_t = C.c_function "SMLBasis" "osSystem"
...
val cfun_exitProc : Int.int -> unit = C.c_function "SMLBasis" "exitProc"
fun exitProc(sts) = let
  val m_sts = (fn (x) => x)(sts)
  val () = cfun_exitProc (m_sts)
  val _ = (fn _ => ()) (m_sts)
in
  ()
end
val cfun_getEnv : String.string -> cfun_ML_string_opt_t = C.c_function "SMLBasis" "getEnv"
fun getEnv(ss) = let
  val m_ss = (fn (x) => x)(ss)
...
val cfun_openDir : String.string -> cfun_ML_directory_t = C.c_function "SMLBasis" "openDir"
...
val cfun_chDir : String.string -> cfun_ML_unit_t = C.c_function "SMLBasis" "chDir"
fun chDir(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_mkDir : String.string -> cfun_ML_unit_t = C.c_function "SMLBasis" "mkDir"
fun mkDir(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_rmDir : String.string -> cfun_ML_unit_t = C.c_function "SMLBasis" "rmDir"
fun rmDir(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_isReg : String.string -> cfun_ML_bool_t = C.c_function "SMLBasis" "isReg"
fun isReg(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_isDir : String.string -> cfun_ML_bool_t = C.c_function "SMLBasis" "isDir"
fun isDir(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_isLink : String.string -> cfun_ML_bool_t = C.c_function "SMLBasis" "isLink"
fun isLink(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_readLink : String.string -> cfun_ML_string_t = C.c_function "SMLBasis" "readLink"
...
val cfun_fileSize : String.string -> cfun_ML_int32_t = C.c_function "SMLBasis" "fileSize"
...
val cfun_modTime : String.string -> cfun_ML_int32_t = C.c_function "SMLBasis" "modTime"
...
val cfun_setTime : (String.string * cfun_Time_t option) -> cfun_ML_unit_t = C.c_function "SMLBasis" "setTime"
...
val cfun_removeFile : String.string -> cfun_ML_unit_t = C.c_function "SMLBasis" "removeFile"
...
val cfun_renameFile : (String.string * String.string) -> cfun_ML_unit_t = C.c_function "SMLBasis" "renameFile"
...
val cfun_fileAccess : (String.string * Int.int) -> cfun_ML_bool_t = C.c_function "SMLBasis" "fileAccess"
...
val cfun_fileId : String.string -> cfun_ML_word8vec_t = C.c_function "SMLBasis" "fileId"
fun fileId(path) = let
  val m_path = (fn (x) => x)(path)
...
val cfun_mkTime : cfun_Date_t -> cfun_Time_t = C.c_function "SMLBasis" "mkTime"
fun mkTime(date) = let
  val m_date = ((fn (x) => x) o ((fn {tm_sec,tm_min,tm_hour,tm_mday,tm_mon,tm_year,tm_wday,tm_yday,tm_isdst} => (tm_sec,tm_min,tm_hour,tm_mday,tm_mon,tm_year,tm_wday,tm_yday,tm_isdst)) o (fn ({tm_sec,tm_min,tm_hour,tm_mday,tm_mon,tm_year,tm_wday,tm_yday,tm_isdst}) => let   val m_tm_sec = (fn (x) => x)(tm_sec)  val m_tm_min = (fn (x) => x)(tm_min)  val m_tm_hour = (fn (x) => x)(tm_hour)  val m_tm_mday = (fn (x) => x)(tm_mday)  val m_tm_mon = (fn (x) => x)(tm_mon)  val m_tm_year = (fn (x) => x)(tm_year)  val m_tm_wday = (fn (x) => x)(tm_wday)  val m_tm_yday = (fn (x) => x)(tm_yday)  val m_tm_isdst = (fn (x) => x)(tm_isdst) in {tm_sec = m_tm_sec,tm_min = m_tm_min,tm_hour = m_tm_hour,tm_mday = m_tm_mday,tm_mon = m_tm_mon,tm_year = m_tm_year,tm_wday = m_tm_wday,tm_yday = m_tm_yday,tm_isdst = m_tm_isdst} end)))(date)
  val (m_time) = cfun_mkTime (m_date)
  val time = (((fn (v) => let   val m_seconds = (fn (x) => x) ((fn (x_0,x_1) => x_0) (v))  val m_uSeconds = (fn (x) => x) ((fn (x_0,x_1) => x_1) (v)) in {seconds = m_seconds,uSeconds = m_uSeconds} end) o (fn (x) => x)) m_time)
  val _ = (fn _ => ()) (m_date)
  val _ = (fn _ => ()) (m_time)
in
  (time)
...
val cfun_cmdName : unit -> String.string = C.c_function "SMLBasis" "cmdName"
fun cmdName() = let

...
in
structure BinPrimIO : BIN_PRIM_IO =
  struct 
	...
	fun readArr asl = let
	    val _ = checkClosed closed
	    val (buf, i, sz) = Word8ArraySlice.base asl
	...
	fun writeVec vsl =
		...
		val (buf, i, sz) = Word8VectorSlice.base vsl
	    in
	...
	fun writeVecNB asl =
	    let val _ = checkClosed closed
		val (buf, i, sz) = Word8VectorSlice.base asl
	...
	fun writeArrNB vsl =
	    let val _ = checkClosed closed
		val (buf, i, sz) = Word8ArraySlice.base vsl

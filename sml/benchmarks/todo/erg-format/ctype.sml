 ...
 *
 * Changes:
 *  920820 - added toUpper, toLower, toAscii  - erg
 *)
...
structure CType : CTYPE =
  ...
  (* conversion routines *)
    ...
    fun convert toFn s =
        case size s of
          1 => chr(toFn(ord s))
        | _ => implode(map (chr o toFn o ord) (explode s))
    val toAscii = convert toAsciiOrd
    val toUpper = convert toUpperOrd
    val toLower = convert toLowerOrd

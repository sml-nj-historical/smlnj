...
structure AMD64ClientPseudoOps = SMLNJPseudoOps(
    structure Asm = AMD64GasPseudoOps)

structure AMD64PseudoOps = PseudoOps(
    structure Client = AMD64ClientPseudoOps)
	      
structure AMD64Stream = InstructionStream(AMD64PseudoOps)

structure AMD64MLTreeStream = MLTreeStream(
    structure T = AMD64MLTree
...
structure AMD64AsmEmitter = AMD64AsmEmitter(
    structure Instr = AMD64Instr
...
structure AMD64MCEmitter = AMD64MCEmitter(
    structure Instr = AMD64Instr

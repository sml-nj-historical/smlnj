...
sig
    ...
    (* access translation: from path to definition point lvar (or lvar to itself) *)
    val get_str_lvar_g : Access.access -> Access.access
    val get_var_lvar_g : Access.access -> Access.access

...
CFUNC("stat_64",   _ml_P_FileSys_stat_64,    "string -> statrep")
CFUNC("lstat",     _ml_P_FileSys_lstat,      "string -> statrep")
CFUNC("lstat_64",  _ml_P_FileSys_lstat_64,   "string -> statrep")
CFUNC("fstat",     _ml_P_FileSys_fstat,      "word -> statrep")
CFUNC("fstat_64",  _ml_P_FileSys_fstat_64,   "word -> statrep")
...
CFUNC("ftruncate_64",_ml_P_FileSys_ftruncate_64,"int * word2 * word32 -> unit")

...
ml_val_t ml_stub_exportHeap (ml_state_t *msp,ml_val_t v) {
  ...
  char *ml_op_fname;
  ml_arg_fname = v;
  ml_op_fname = PTR_MLtoC (char,ml_arg_fname);
...
ml_val_t ml_stub_debug (ml_state_t *msp,ml_val_t v) {
  ...
  char *ml_op_s;
  ml_arg_s = v;
  ml_op_s = PTR_MLtoC (char,ml_arg_s);
  debug (msp,ml_op_s);
  return ML_unit;
}

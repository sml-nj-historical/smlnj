...
signature FILENAMEPOLICY = sig
    ...
    val mkSrcinfoName : policy -> SrcPath.file -> string
...
functor FilenamePolicyFn (val cmdir : string
	...
	{ skel = cmname [skeldir] o SrcPath.osstring,
	  srcinfo = cmname [infodir] o SrcPath.osstring,
    ...
    fun mkSrcinfoName (p: policy) s = #srcinfo p s

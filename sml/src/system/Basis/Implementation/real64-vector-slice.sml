 ...
 *
 * Implements MONO_VECTOR_SLICE =
 *)

(* Basis specifies structure named RealVectorSlice. [dbm] *)
...
(* utility functions *)
  fun checkLen n =
      if InlineT.DfltInt.ltu(Vector.maxLen, n)  (* Real64Vector defined using  Vector *)
	  then raise General.Size
      else ()

  (* rev: reverse append first arg onto second arg *)
  fun rev ([], l) = l
    | rev (x::r, l) = rev (r, x::l)
...
end (* structure Real64VectorSlice *)

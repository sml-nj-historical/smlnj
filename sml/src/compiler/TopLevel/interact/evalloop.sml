...
fun interact (interactParams) : unit =
    let val source = Source.newSource("stdIn",1,TextIO.stdIn,true,
       ...
       fun flush() = (#anyErrors source := false; 
        ...
        local val p1 = Substring.isPrefix "1-TopLevel/interact/evalloop.sml:"
              val p2 = Substring.isPrefix "1-TopLevel/main/compile.sml:"
              val p3 = Substring.isPrefix "9-MiscUtil/util/stats.sml:"
           in fun edit [s] = [s]
                | edit nil = nil
                | edit (s::r) = 

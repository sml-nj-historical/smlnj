 ...
 * Revision 1.24  1998/01/15 23:33:01  dbm
 *   Fix for bug 1338.
 *
 * Revision 1.23  1997/12/16 15:42:34  dbm
 *   Fix for bug 1318.  Reverse last return value of instGeneric.
 *
 * Revision 1.22  1997/11/11  05:25:27  dbm
 *   Cleanup error messages (lower case).
 *
 * Revision 1.21  1997/10/19  23:49:23  dbm
 *   As part of the fix for bug 1297 (pickling blowup), added a MARKeenv
 *   to the entityEnv used as the base the fold in the body of instToEntity.
 *   This helps speed up pickling, but doesn't affect the pickle size.
 *
 * Revision 1.20  1997/10/03  15:08:55  dbm
 *   Fix for bug 1285.
 *
 * Revision 1.19  1997/09/30  02:29:31  dbm
 *   Fixed calculation of functor paths.
 *
 * Revision 1.18  1997/09/23  03:56:11  dbm
 *   Fix for EntityEnv.Unbound (bugs 1270, 1271).
 *   Fix for type printing problems (?...).
 *
 * Revision 1.17  1997/09/10  22:15:00  dbm
 *   Fix secondary error bug 1274.
 *
 * Revision 1.16  1997/09/05  17:48:39  dbm
 *   Commented out another "definition spec inside of sharing" warning.
 *
 * Revision 1.15  1997/09/05  04:46:09  dbm
 *   Added inherited rpath to type paths so that type names will be
 *   printed more accurately, particularly for "abstraction"
 *   structures (i.e. structures with opaque signature constraints).
 *
 * Revision 1.14  1997/08/22  18:38:26  george
 *   Add code to let instAbstr export a list of entity paths for flexible
 *   type constructors.
 * 							--- zsh
 *
 * Revision 1.13  1997/08/15  20:43:41  dbm
 *   Modified type of constructor GENERATE_ENT of entInfo to carry a boolean.
 *   The boolean argument tells whether there was a VARstrDef definition
 *   with a different signature from the spec.
 *
 * Revision 1.12  1997/07/17  20:40:05  dbm
 *   Temporarily commented out "level" testing and the warning about
 *   definitions inside of sharing.
 *
 * Revision 1.11  1997/07/16  19:44:10  dbm
 *   Fix for bug 1232.
 *
 * Revision 1.10  1997/07/15  16:09:33  dbm
 *   Major rewrite.  extdefs elimininated, definition constraints separated
 *   from sharing constraints, realizations shared with defining structures.
 *
 * Revision 1.9  1997/06/30  19:37:31  jhr
 *   Removed System structure; added Unsafe structure.
 *
 * Revision 1.8  1997/05/22  03:29:27  dbm
 *   Significant clarification of treatment of INST/NOTINST tycons (see bug 1201).
 *   Some external tycInsts have to be instantiated, if they refer to previous
 *   types in a larger signature (see bug 1200).
 *
 * Revision 1.7  1997/05/20  12:22:49  dbm
 *   SML '97 sharing, where structure.
 *
 * Revision 1.6  1997/04/14  21:32:40  dbm
 *   Eliminated redundant rule in function eqMax.
 *
 * Revision 1.5  1997/04/10  14:39:00  dbm
 *   Bug fix - 1136, 1152.  Used accumulated eqprop for type equivalence
 *   class representative.  Still needs reworking.
 *
 * Revision 1.4  1997/03/24  22:20:28  dbm
 *   Added comment in distributeT regarding treatment of extdefs.
 *
 * Revision 1.3  1997/03/17  18:50:54  dbm
 * Changes in datatype representation to support datatype replication.
 *
 * Revision 1.2  1997/02/26  21:51:40  george
 ...
 *   mysterious bugs. In summary, this changes fixed BUG 1138 and BUG 1155.
 *
 *)

...
(*#line 654.7 "hppa/hppa.md"*)
   fun opn opnd = let

(*#line 655.11 "hppa/hppa.md"*)
          fun hi21 n = (itow n) >> 0wxb

(*#line 656.11 "hppa/hppa.md"*)
          fun hi21X n = (itow n) ~>> 0wxb

(*#line 657.11 "hppa/hppa.md"*)
...
(*#line 673.6 "hppa/hppa.md"*)
   fun assemble_3 n = let

(*#line 674.10 "hppa/hppa.md"*)
          val w1 = (n && 0wx4) >> 0wx2
...
(*#line 678.6 "hppa/hppa.md"*)
   fun assemble_12 n = let

(*#line 679.10 "hppa/hppa.md"*)
          val w = (n && 0wx800) >> 0wxb

(*#line 680.10 "hppa/hppa.md"*)
...
(*#line 702.6 "hppa/hppa.md"*)
   fun bcond (cmp, bc, r1, r2, n, t, nop) = let

(*#line 703.10 "hppa/hppa.md"*)
...
(*#line 706.6 "hppa/hppa.md"*)
   fun bcondi (cmpi, bc, i, r2, n, t, nop) = let

(*#line 707.10 "hppa/hppa.md"*)
          val (w1, w) = assemble_12 (disp t)
...
(*#line 711.6 "hppa/hppa.md"*)
   fun branchOnBit (bc, r, p, n, t, nop) = let

(*#line 712.10 "hppa/hppa.md"*)
          val (w1, w) = assemble_12 (disp t)

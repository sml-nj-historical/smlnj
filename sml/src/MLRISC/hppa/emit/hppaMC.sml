...
struct
   ...
   and emit_CC r = itow ((regmap r) - 96)
   and emit_MEM r = itow ((regmap r) - 96)
   and emit_CTRL r = itow ((regmap r) - 96)
   ...
   and CompareClear {r2, r1, c, f, ext, t} = let
          val r2 = emit_GP r2
          val r1 = emit_GP r1
          val t = emit_GP t
   ...
   and CompareImmClear {r, t, c, f, im11} = let
          val r = emit_GP r
          val t = emit_GP t
...
(*#line 647.7 "hppa/hppa.md"*)
   fun opn opnd = let

(*#line 648.11 "hppa/hppa.md"*)
          fun hi21 n = (itow n) >> 0wxb

(*#line 649.11 "hppa/hppa.md"*)
          fun hi21X n = (itow n) ~>> 0wxb

(*#line 650.11 "hppa/hppa.md"*)
...
(*#line 661.6 "hppa/hppa.md"*)
   fun disp lab = (itow (((Label.addrOf lab) - ( ! loc)) - 8)) ~>> 0wx2

(*#line 662.6 "hppa/hppa.md"*)
...
(*#line 664.6 "hppa/hppa.md"*)
   fun low_sign_ext_im5 n = ((n && 0wxf) << 0wx1) || ((n && 0wx10) >> 0wx4)

(*#line 666.6 "hppa/hppa.md"*)
   fun assemble_3 n = let

(*#line 667.10 "hppa/hppa.md"*)
          val w1 = (n && 0wx4) >> 0wx2

(*#line 668.10 "hppa/hppa.md"*)
          val w2 = (n && 0wx3) << 0wx1
       in w1 || w2
       end


(*#line 671.6 "hppa/hppa.md"*)
...
(*#line 678.10 "hppa/hppa.md"*)
          val w1 = (n && 0wxf800) >> 0wxb

(*#line 679.10 "hppa/hppa.md"*)
          val w2 = ((n && 0wx3ff) << 0wx1) || ((n && 0wx400) >> 0wxa)
       in (w, w1, w2)
       end


(*#line 682.6 "hppa/hppa.md"*)
   fun assemble_21 disp = let

(*#line 683.10 "hppa/hppa.md"*)
...
(*#line 695.6 "hppa/hppa.md"*)
   fun bcond (cmp, bc, r1, r2, n, t, nop) = let

(*#line 696.10 "hppa/hppa.md"*)
...
(*#line 699.6 "hppa/hppa.md"*)
   fun bcondi (cmpi, bc, i, r2, n, t, nop) = let

(*#line 700.10 "hppa/hppa.md"*)
          val (w1, w) = assemble_12 (disp t)
...
(*#line 704.6 "hppa/hppa.md"*)
   fun branchOnBit (bc, r, p, n, t, nop) = let

(*#line 705.10 "hppa/hppa.md"*)
          val (w1, w) = assemble_12 (disp t)

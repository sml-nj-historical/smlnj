...
struct
   ...
   let fun stm s =
      ...
      let val e = case e of
           ...
           | T.DIVS(ty,x,y) => T.DIVS(ty,rexp x,rexp y)
           | T.QUOTS(ty,x,y) => T.QUOTS(ty,rexp x,rexp y)
           | T.REMS(ty,x,y) => T.REMS(ty,rexp x,rexp y)
           ...
           | T.DIVT(ty,x,y) => T.DIVT(ty,rexp x,rexp y)
           | T.QUOTT(ty,x,y) => T.QUOTT(ty,rexp x,rexp y)
           | T.REMT(ty,x,y) => T.REMT(ty,rexp x,rexp y)

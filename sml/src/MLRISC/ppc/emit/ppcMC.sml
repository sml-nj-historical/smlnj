...
struct
   ...
   and emit_SPR r = itow ((regmap r) - 72)
   and emit_MEM r = itow ((regmap r) - 104)
   and emit_CTRL r = itow ((regmap r) - 104)
   ...
   fun x_form {opcd, rt, ra, rb, xo, rc} = let
          val rc = emit_bool rc

...
(*#line 439.22 "alpha/alpha.md"*)
          val i = LabelExp.valueOf le

(*#line 440.22 "alpha/alpha.md"*)
          val w = itow i

(*#line 441.22 "alpha/alpha.md"*)
          val hi = w ~>> 0wx10

(*#line 442.22 "alpha/alpha.md"*)
          val lo = w && 0wxffff
       in (if (lo < 0wx8000)
             then (hi, lo)

...
struct
   ...
   fun emitInstr instr = 
      ...
      | I.JMPL({r, b, d}, label) => 
        ...
        (emit_GP b); 
        (emit ")"))
      | I.JSR({r, b, d}, cellset1, cellset2, region) => 
        ((emit "jsr\t"); 
        (emit_GP r); 
        (emit ", ("); 
        (emit_GP b); 
      ...
      | I.RET{r, b, d} => 
        ...
        (emit_GP b); 
        (emit ")"))
      | I.BRANCH(branch, GP, label) => 
        ((emit_branch branch); 
        (emit "\t"); 
        (emit_GP GP); 
        (emit ", "); 
        (emit_label label))
      | I.FBRANCH(fbranch, FP, label) => 
...
(*#line 313.1 "alpha/alpha.md"*)
        ...
        in 
          ...
          | (I.ADDQ, 30, I.CONSTop b, 30) => (if ((Constant.valueOf b) = 0)
               then ()
               else (f ("addq", ra, rb, rc)))
          | (I.SUBL, 30, I.CONSTop b, 30) => (if ((Constant.valueOf b) = 0)
               then ()
               else (f ("subl", ra, rb, rc)))
          | (I.SUBQ, 30, I.CONSTop b, 30) => (if ((Constant.valueOf b) = 0)
               then ()
               else (f ("subq", ra, rb, rc)))

...
struct
  ...
  fun isSdi(I.DEFFREG _) 	          = true
    ...
    | isSdi(I.CMOVE{rb=I.CONSTop _, ...}) = true
    | isSdi(I.COPY _)			  = true
  ...
  fun im8Oper c = if immed8(Const.valueOf c) then 4 else 12
  ...
  fun sdiSize(I.DEFFREG _, _, _, _) = 0
    ...
    | sdiSize(I.OPERATE{rb=I.CONSTop c, ...}, _, _, _) = im8Oper c
    | sdiSize(I.OPERATEV{rb=I.CONSTop c, ...}, _, _, _) = im8Oper c
    | sdiSize(I.CMOVE{rb=I.CONSTop c, ...}, _, _, _) = im8Oper c

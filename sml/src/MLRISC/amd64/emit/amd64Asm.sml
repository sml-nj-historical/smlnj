...
(*#line 560.7 "amd64/amd64.mdl"*)
                        structure MemRegs : MEMORY_REGISTERS where I=Instr

(*#line 561.7 "amd64/amd64.mdl"*)
...
(*#line 563.6 "amd64/amd64.mdl"*)
   fun memReg r = MemRegs.memReg {reg=r, base=Option.valOf memRegBase}

(*#line 564.6 "amd64/amd64.mdl"*)
   fun emitInt32 i = 
       let 
(*#line 565.10 "amd64/amd64.mdl"*)
           val s = Int32.toString i

(*#line 566.10 "amd64/amd64.mdl"*)
           val s = (if (i >= 0)
                  then s
...
(*#line 569.6 "amd64/amd64.mdl"*)
   val {low=SToffset, ...} = C.cellRange CellsBasis.FP

(*#line 571.6 "amd64/amd64.mdl"*)
...
(*#line 628.7 "amd64/amd64.mdl"*)
   fun chop fbinOp = 
       let 
(*#line 629.15 "amd64/amd64.mdl"*)
           val n = size fbinOp
       in 
...
(*#line 635.7 "amd64/amd64.mdl"*)
   fun isST0 (I.ST r) = (CellsBasis.registerNum r) = 0
     | isST0 _ = false

(*#line 639.7 "amd64/amd64.mdl"*)
...
(*#line 649.7 "amd64/amd64.mdl"*)
   val emit_dst = emit_operand

(*#line 650.7 "amd64/amd64.mdl"*)
   val emit_src = emit_operand

(*#line 651.7 "amd64/amd64.mdl"*)
   val emit_opnd = emit_operand

(*#line 652.7 "amd64/amd64.mdl"*)
   val emit_opnd8 = emit_operand8

(*#line 653.7 "amd64/amd64.mdl"*)
   val emit_rsrc = emit_operand

(*#line 654.7 "amd64/amd64.mdl"*)
   val emit_lsrc = emit_operand

(*#line 655.7 "amd64/amd64.mdl"*)
   val emit_addr = emit_operand

(*#line 656.7 "amd64/amd64.mdl"*)
   val emit_src1 = emit_operand

(*#line 657.7 "amd64/amd64.mdl"*)
   val emit_ea = emit_operand

(*#line 658.7 "amd64/amd64.mdl"*)

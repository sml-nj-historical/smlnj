...
struct
  ...
  and emitAMD64Instr instr = 
	  ...
	  fun eREX64 rb = eREX rb + 0wx8
	    ...
	    | eImmedExt(r', opnd as I.FDirect f) = eImmedExt (r', memReg opnd)
	  ...
	  (case instr
	    of I.UNARY{unOp, opnd} => 
	     ...
	     | I.LEA{r32, addr} => encodeReg32(0wx8d, r32, addr)			  
...
(* FIXME: add CALLQ *)
	     ...
	     | I.FBINARY{binOp, src, dst=I.ST dst} => 
		   ...
		   let
			   ...
			   (*esac*))
		   in encode32 (opc, opcode code, src)
		   end
	       else error "FBINARY"
	     | I.FIBINARY{binOp, src} => 
	       let val (opc, code) =
			 ...
			 | I.FIDIVS  => (0wxde, 6)
			 | I.FIDIVRS => (0wxde, 7)
	       in  encode32 (opc, opcode code, src) end
	     | I.FUNARY unOp =>
               eBytes[0wxd9, 
		      case unOp 
		       of I.FABS => 0wxe1 
	     ...
	     | I.FSTS opnd  => encode32(0wxd9, opcode 2, opnd)
	     | I.FSTL(I.ST n) => encodeST(0wxdd, 26, n)
	     | I.FSTL opnd  => encode32(0wxdd, opcode 2, opnd)

	     | I.FSTPS opnd => encode32(0wxd9, opcode 3, opnd)
	     | I.FSTPL(I.ST n) => encodeST(0wxdd, 27, n)
	     | I.FSTPL opnd => encode32(0wxdd, opcode 3, opnd)
	     | I.FSTPT opnd => encode32(0wxdb, opcode 7, opnd)
	     ...
	     | I.FLDS opnd => encode32(0wxd9, opcode 0, opnd)
			     
	     | I.FLDL(I.ST n) => encodeST(0wxd9, 24, n)
	     | I.FLDL opnd => encode32(0wxdd, opcode 0, opnd)
			     
	     | I.FILD opnd => encode32(0wxdf, opcode 0, opnd)
	     | I.FILDL opnd => encode32(0wxdb, opcode 0, opnd)
	     | I.FILDLL opnd => encode32(0wxdf, opcode 5, opnd)

...
struct
   ...
   and emit_MEM r = itow ((regmap r) - 67)
   and emit_CTRL r = itow ((regmap r) - 67)
...
(*#line 480.11 "sparc/sparc.md"*)
          fun hi22 w = (itow w) ~>> 0wxa

(*#line 481.11 "sparc/sparc.md"*)

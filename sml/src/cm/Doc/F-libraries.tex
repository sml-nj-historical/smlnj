...
\begin{small}
\begin{center}
\begin{tabular}{p{2.2in}||p{3in}|c|c}
name & description & installed & loaded \\
\hline\hline
{\tt \$smlnj/cmb.cm} \newline
...
\hline
{\tt \$smlnj/compiler/all.cm} & visible compilers and
bootstrap compilers for all architectures
visible compilers for all & always & no
\end{tabular}
\end{center}
\end{small}

...
The noweb tool takes a list of targets.  Each target individually can
have a variety of options.  A target is specified by a separate
tool option labelled {\tt target}.  The tool option usually has the
form of a sub-option list.  Recognized sub-options are:

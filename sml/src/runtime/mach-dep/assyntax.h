...
#define	FSAVE(a)	CHOICE(fsave a, fwait; fnsave a, fwait; fsave a)
...
/* Indirect Mode */
#define X_CONTENT(a) 	tbyte ptr a
#define D_CONTENT(a) 	qword ptr a
#define L_CONTENT(a) 	dword ptr a
#define W_CONTENT(a) 	word ptr a
#define B_CONTENT(a) 	byte ptr a

/* Register a indirect */
#define X_REGIND(a) 	tbyte ptr [a]
#define D_REGIND(a) 	qword ptr [a]
#define L_REGIND(a) 	dword ptr [a]
#define W_REGIND(a) 	word ptr [a]
#define B_REGIND(a) 	byte ptr [a]

/* Register b indirect plus displacement a */
#define X_REGOFF(a, b) 	tbyte ptr [a + b]
#define D_REGOFF(a, b) 	qword ptr [a + b]
#define L_REGOFF(a, b) 	dword ptr [a + b]
#define W_REGOFF(a, b) 	word ptr [a + b]
#define B_REGOFF(a, b) 	byte ptr [a + b]

/* Reg indirect Base + Index + Displacement  - this is mainly for 16-bit mode
 * which has no scaling
 */
#define X_REGBID(b, i, d) 	tbyte ptr [b + i + d]
#define D_REGBID(b, i, d) 	qword ptr [b + i + d]
#define L_REGBID(b, i, d) 	dword ptr [b + i + d]
#define W_REGBID(b, i, d) 	word ptr [b + i + d]
#define B_REGBID(b, i, d) 	byte ptr [b + i + d]

/* Reg indirect Base + (Index * Scale) + Displacement */
#define X_REGBISD(b, i, s, d) 	tbyte ptr [b + i * s + d]
#define D_REGBISD(b, i, s, d) 	qword ptr [b + i * s + d]
#define L_REGBISD(b, i, s, d) 	dword ptr [b + i * s + d]
#define W_REGBISD(b, i, s, d) 	word ptr [b + i * s + d]
#define B_REGBISD(b, i, s, d) 	byte ptr [b + i * s + d]

/* Displaced Scaled Index: */
#define X_REGDIS(d, i, s) 	tbyte ptr [i * s + d]
#define D_REGDIS(d, i, s) 	qword ptr [i * s + d]
#define L_REGDIS(d, i, s) 	dword ptr [i * s + d]
#define W_REGDIS(d, i, s) 	word ptr [i * s + d]
#define B_REGDIS(d, i, s) 	byte ptr [i * s + d]

/* Indexed Base: */
#define X_REGBI(b, i) 	tbyte ptr [b + i]
#define D_REGBI(b, i) 	qword ptr [b + i]
#define L_REGBI(b, i) 	dword ptr [b + i]
#define W_REGBI(b, i) 	word ptr [b + i]
#define B_REGBI(b, i) 	byte ptr [b + i]

/* Displaced Base: */
#define X_REGDB(d, b) 	tbyte ptr [b + d]
#define D_REGDB(d, b) 	qword ptr [b + d]
#define L_REGDB(d, b) 	dword ptr [b + d]
#define W_REGDB(d, b) 	word ptr [b + d]
#define B_REGDB(d, b) 	byte ptr [b + d]
...
#define	JLE(a)		jle a
#define	JNA(a)		jna a
#define	JNAE(a)		jnae a
#define	JNB(a)		jnb a
#define	JNBE(a)		jnbe a
#define	JNC(a)		jnc a
#define	JNE(a)		jne a
#define	JNG(a)		jng a
#define	JNGE(a)		jnge a
#define	JNL(a)		jnl a
#define	JNLE(a)		jnle a
#define	JNO(a)		jno a
#define	JNP(a)		jnp a
#define	JNS(a)		jns a
#define	JNZ(a)		jnz a

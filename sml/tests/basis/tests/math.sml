...
(*    val MINDOUBLE = 4.94065645841246544E~324  not used -- lal *) 
    ...
    val posInf = 1.0/0.0
    val negInf = ~posInf
    fun isNegInf x = Real.==(x, negInf)
    fun isPosInf x = Real.==(x, posInf)
in
...
val test1c = check(Real.isNan(sqrt ~1.0))
...
val test5d = check(Real.isNan(asin 1.1));
val test5e = check(Real.isNan(asin ~1.1));

val test6a = check1(acos, 1.0, 0.0);
val test6b = check1(acos, 0.0, pi/2.0);
val test6c = check1(acos, ~1.0, pi);
val test6d = check(Real.isNan(acos 1.1));
val test6e = check(Real.isNan(acos ~1.1));
...
val test10d = check(isNegInf(ln 0.0))
val test10e = check(Real.isNan(ln ~1.0))
...
val test12j = check(isPosInf(pow(0.0, ~1.0)))
val test12k = check(isPosInf(pow(0.0, ~0.5)))
val test12l = check(Real.isNan(pow(~1.0, 1.1)))
val test12m = check(Real.isNan(pow(~1.0, 0.5)))
...
val check15aa = check1(cosh, 0.0, 1.0);
val check15bb = check1(cosh,  1.0, 1.54308063482);
val check15cc = check1(cosh, ~1.0, 1.54308063482);
val check15dd = check1(cosh,  2.0, 3.76219569108);
val check15ee = check1(cosh, ~2.0, 3.76219569108);
